    ...
    return(
        <ContainerContact id='contact'>
            ...
            <SubContainerContact>
                ...
                <BoxContact target='_blank' href="mailto:nicolas.saraivaa@gmail.com">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 0C6.71625 0 0 6.71625 0 15C0 23.2837 6.71625 30 15 30C23.2837 30 30 23.2837 30 15C30 6.71625 23.2837 0 15 0V0ZM23.7375 8.725L15 15.8075L6.26125 8.725H23.7375ZM23.75 21.225H6.25V10.5937L15 17.685L23.75 10.595V21.225Z" fill='#ffff' />
                    </Icon>

                    <BoxTexts>
                        <LinkText>contato@nicolassaraivaa</LinkText>
                    </BoxTexts>

                </BoxContact>

                <BoxContact target="_blank" href="https://wa.me/5511988804583?text=">
                    ...
                    <BoxTexts>
                        <LinkText>(11) 98880-4583</LinkText>
                    </BoxTexts>

                </BoxContact>

                <BoxCV target='_blank' href={"https://drive.google.com/file/d/1jJixK3MSwdxpm2rWnBLCxAgebVIgZIl0/view?usp=sharing"} download="Nicolas Saraiva - Currículo">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                <Image src={photoContact} alt="foto-contato" />
            </div>
